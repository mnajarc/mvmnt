...
class PaginasControllerTest < ActionController::TestCase
  ...
  test "should create pagina" do
    assert_difference('Pagina.count') do
      post :create, pagina: { ancestry: @pagina.ancestry, contenido: @pagina.contenido, nombre: @pagina.nombre }
    end
  ...
  test "should update pagina" do
    patch :update, id: @pagina, pagina: { ancestry: @pagina.ancestry, contenido: @pagina.contenido, nombre: @pagina.nombre }
    assert_redirected_to pagina_path(assigns(:pagina))
  end
