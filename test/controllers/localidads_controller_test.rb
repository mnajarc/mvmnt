...
class LocalidadsControllerTest < ActionController::TestCase
  ...
  test "should create localidad" do
    assert_difference('Localidad.count') do
      post :create, localidad: { estado_id: @localidad.estado_id, nombre_localidad: @localidad.nombre_localidad }
    end
  ...
  test "should update localidad" do
    patch :update, id: @localidad, localidad: { estado_id: @localidad.estado_id, nombre_localidad: @localidad.nombre_localidad }
    assert_redirected_to localidad_path(assigns(:localidad))
  end
